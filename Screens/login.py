...
class Login(ctk.CTk):
    def __init__(self):
        ...
        self.configure(bg=non_dominant_color)
        screen_width = self.winfo_screenwidth()
        screen_height = self.winfo_screenheight()
        self.geometry("{}x{}+{}+{}".format(screen_width, screen_height, 0, 0))
        mainframe = ctk.CTkFrame(master=self, fg_color=non_dominant_color)
        ...
        ctk.CTkLabel(master=mainframe, text='Welcome to KONGKNITEC', anchor='center',
                     text_font=(font, 10, "bold"), text_color=dominant_color).grid(row=1, column=0, columnspan=2)
        ...
        forgot_password = ctk.CTkButton(master=mainframe, text='FORGOT PASSWORD ?', cursor="hand2",
                                        fg_color=non_dominant_color, text_font=(font, 7, "bold"),
                                        hover_color=non_dominant_color, command=lambda: pressed('hello'),
        ...
        create_button = ctk.CTkButton(master=mainframe, text='Sign-up', width=70, height=35,
                                      cursor="hand2", fg_color=non_dominant_color, hover_color=non_dominant_color,
