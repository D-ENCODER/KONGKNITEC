...
class Profile(ctk.CTkFrame):
    ...
    def __profileGUI(self):
        ...
        ctk.CTkLabel(master=self.firstname_frame, text='First Name', font=(configure.font, 12, 'bold'),
        ...
        ctk.CTkLabel(master=self.lastname_frame, text='Last Name', font=(configure.font, 12, 'bold'),
                     width=30).grid(row=1, column=0, sticky='e')
        ...
        ctk.CTkLabel(master=self.email_frame, text='E-mail', font=(configure.font, 12, 'bold'),
                     width=30).grid(row=1, column=0, sticky='e')
        ...
        ctk.CTkLabel(master=self, text='Contact', font=(configure.font, 12, 'bold'),
        ...
        ctk.CTkLabel(master=self.birth_frame, text='DoB', font=(configure.font, 12, 'bold'),
        ...
        ctk.CTkLabel(master=self.birth_frame, text='/', font=(configure.font, 12, 'bold'),
