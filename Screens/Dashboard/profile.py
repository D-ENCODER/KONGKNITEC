...
class Profile(ctk.CTkFrame):
    ...
    def __profileGUI(self):
        ...
        ctk.CTkLabel(master=self.firstname_frame, text='First Name', font=(configure.font, 17, 'bold'),
        ...
        ctk.CTkLabel(master=self.lastname_frame, text='Last Name', font=(configure.font, 17, 'bold'),
                     width=30).grid(row=1, column=0, sticky='e')
        ...
        ctk.CTkLabel(master=self.email_frame, text='E-mail', font=(configure.font, 17, 'bold'),
                     width=30).grid(row=1, column=0, sticky='e')
        ...
        self.email_entry.bind('<FocusOut>', lambda event: self.validateEmail())
    ...
    def validateEmail(self):
        ...
        if Validator.validate_email(self.email_entry.get())[0]:
            ...
            self.email_error_label.grid(row=2, column=0, columnspan=2)
