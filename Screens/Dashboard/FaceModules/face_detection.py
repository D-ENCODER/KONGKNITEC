...
class FaceDetection(ctk.CTkToplevel):
    def __init__(self, *args, **kwargs):
        ...
        self.__error = ctk.CTkLabel(self)
        self.__take_photo = ctk.CTkButton(self, text="Take Photo")
        self.__take_photo.grid(row=1, column=1, sticky="nsew")
        self.__detect_face()
    ...
    def __detect_face(self):
        ...
        if not faces2:
            ...
            self.__error.grid(row=1, column=0)
            ...
            for result in faces2:
                ...
                if len(faces) > 1:
                    ...
                    def save():
                        cv2.imwrite("Dataset/{}.jpg".format(self.__name), frame)
                        self.onClosing()
